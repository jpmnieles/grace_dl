...
class GraceDataModule(LightningDataModule):
    ...
    def preprocess_csv(self, data_dir):
        ...
        train_df, temp_df = train_test_split(scaled_df, test_size=self.val_size, random_state=self.seed)
        val_df, test_df = train_test_split(temp_df, test_size=1/3, random_state=self.seed)
