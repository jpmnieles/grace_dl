...
var_dict= {
    ...
    'lefteye_cam_rot_r': -1.56,
    'lefteye_cam_rot_p': 0.0,
    'lefteye_cam_rot_y': -1.38,

    'righteye_cam_rot_r': -1.5,
    'righteye_cam_rot_p': 0.0,
    'righteye_cam_rot_y': -1.8,
...
def main():
    ...
    print(dict(zip(var_names_list, opt.grad)))
