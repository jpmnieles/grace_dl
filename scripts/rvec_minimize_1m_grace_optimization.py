...
# Load Dataset CSV
data_dir = "final"
csv_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),"..","data", data_dir, "241004_1m_grace_dataset.csv")
...
def main():
    ...
    urdf_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..','urdf', '1m_grace_results.urdf')
    ...
    res_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..','results', res_fn+'_1m_grace_results.csv')
