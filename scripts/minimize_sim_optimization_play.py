...
var_dict= {
    ...
    # 'lefteye_cam_origin_x': 0,
    # 'righteye_cam_origin_x': 0,

    'eyes_pitch_origin_x': 0.08292,
    'eyes_pitch_origin_z': 0.05386,
...
def main():
    ...
    opt = minimize(objective_function, V, args=(x_c_l, y_c_l, z_c_l, x_c_r, y_c_r, z_c_r,
                                                 ...
                                                 bounds=((0,3),(0,3),(0,3),(0,3),(0,3),(0,3),
                                                         (-3.1416,0),(-3.1416,0),(-3.1416,0),(-3.1416,0),(0,1),(0,1)))
